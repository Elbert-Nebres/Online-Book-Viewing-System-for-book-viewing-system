...
<body class="text-start" style="font-size: 30px; border-bottom-color: rgb(0,0,0);">
    ...
    <div class="container-fluid">
            ...
            <li class="nav-item"><a class="nav-link" href="index.php">Search Book</a></li>
            <li class="nav-item"><a class="nav-link" href="logoutADMIN.php">Logout</a></li> <!-- Added logout button -->
        </ul>
        </div>
    </nav>
</div>
